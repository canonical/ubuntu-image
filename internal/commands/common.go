...
// set up the options that are common to both snap and classic commands
type commonOpts struct {
	...
	HooksDirectory string `long:"hooks-directory" description:"Path or comma-separated list of paths of directories in which scripts for build-time hooks will be located." value-name:"DIRECTORY"`
