...
type CommonOpts struct {
	...
	SubCmdOutput     bool     `long:"sub-command-output" description:"Enable output of sub-commands called by ubuntu-image. This includes but is not limited to: germinate, debootstrap, and apt commands."`
